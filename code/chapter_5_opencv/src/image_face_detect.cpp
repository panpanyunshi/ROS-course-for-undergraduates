...
std::string face_cascade_name = "/home/xzm/ros_tutorial_v2/src/chapter_5_opencv/config/haarcascade_frontalface_alt.xml"; /*must be absulute path*/
...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "image_face_detect");
    ImageConverter ic;
    ros::spin();
    return 0;
}